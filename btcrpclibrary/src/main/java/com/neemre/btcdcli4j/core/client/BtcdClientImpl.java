...
public class BtcdClientImpl implements BtcdClient {
	...
	public BtcdClientImpl(OkHttpClient httpProvider, Properties nodeConfig)
...
//		configurator.checkNodeHealth((Block)getBlock(getBestBlockHash(), true));
	...
	public BtcdClientImpl(OkHttpClient httpProvider, String rpcUser, String rpcPassword) 
			throws BitcoindException, CommunicationException {
	...
	public BtcdClientImpl(OkHttpClient httpProvider, String rpcHost, Integer rpcPort, 
	...
	public BtcdClientImpl(OkHttpClient httpProvider, String rpcProtocol, String rpcHost,
	...
	public Info getInfo() throws BitcoindException, CommunicationException {
		...
		System.out.println("info===>:"+infoJson);
	...
	@Override
	public String getRawTransaction2(String txId,Boolean verbosity) throws BitcoindException, CommunicationException {
		List<Object> params = CollectionUtils.asList(txId, verbosity);
		String hexTransactionJson = rpcClient.execute(Commands.GET_RAW_TRANSACTION.getName(), params);
		String hexTransaction = rpcClient.getParser().parseString(hexTransactionJson);
		return hexTransaction;
	}
